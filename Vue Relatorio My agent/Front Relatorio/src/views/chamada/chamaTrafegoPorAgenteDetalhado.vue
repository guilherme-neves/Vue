...
import ChamadaFields from "../../service/chamado/chamadoTrafegoPorAgenteDetalhado";
...
export default {
  ...
  data() {
    return {
      ...
      dataFim: "",
      agente: "",
      fields: ChamadaFields.fields,
      caption: ""
    };
  },
  created() {
    this.resource = this.$resource("callTrafficOneAgentPerHourDailyDetails");
  },
  methods: {
    pesquisar() {
      var _campos = {
