...
import AgenteFields from "../../service/agente/AgenteChamadaDetalhe";
...
export default {
  ...
  created() {
    this.resource = this.$resource("agentPrivateCallPerAgent");
  },
  methods: {
    pesquisar() {
      var _campos = {
    ...
    exportPdf() {
      ...
      let columns = [
        { title: "Date", dataKey: "Date of Call" },
        { title: "Time", dataKey: "Time of Call" },
        { title: "Origem", dataKey: "ch_called_number" },
        { title: "Destino", dataKey: "ch_calling_number" },
        { title: "Duração", dataKey: "ch_talk_time_seconds" },
        { title: "Direção", dataKey: "ch_direction" },
        { title: "Empresa", dataKey: "cc_contact" }
      ];
