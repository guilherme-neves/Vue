...
import AgenteFields from "../../service/agente/AgenteTempoPausaFields";
...
export default {
  ...
  created() {
    this.resource = this.$resource("agentBreakTime");
  },
  methods: {
    pesquisar() {
      var _campos = {
    ...
    exportPdf() {
      ...
      let columns = [
        ...
        { title: "Duração", dataKey: "timeinsec" },
        { title: "Pausa", dataKey: "break_name" },
        { title: "Intervalo", dataKey: "break_default_interval_minutes" }
      ];
